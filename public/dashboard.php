    ...
    <header class="border-bottom border-secondary py-3 mb-4">
        <div class="container d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                <span class="text-secondary">Welcome, <?= e($userName); ?></span>
                ...
                <div class="col-md-6">
                    <div class="card bg-secondary text-white shadow-sm h-100">
                        <div class="card-body">
                            ...
                            <p class="display-5 fw-bold mb-0"><?= number_format($totalUsers); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card bg-secondary text-white shadow-sm h-100">
                        <div class="card-body">
                            ...
                            <p class="display-5 fw-bold mb-0"><?= number_format($totalAds); ?></p>
                        </div>
                    </div>
                </div>
            </div>
